...
public class VoteService {
    ...
    public List<VoteItemDto> getVoteItems(Long voteId) {
        return voteItemRepository.findByVoteId(voteId)
                .stream()
    ...
    public List<VoteResponseDto> getVoteResults(Long voteId) {
        return voteItemRepository.findByVoteId(voteId)
                .stream()
    ...
    public boolean hasVoted(Long userId, Long voteId) {
        return voteRecordRepository.existsByUserIdAndVoteId(userId, voteId);
    }
